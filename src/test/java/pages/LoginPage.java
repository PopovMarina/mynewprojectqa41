...
public class LoginPage extends BasePage{
    ...
    // Эта строка использует аннотацию @FindBy для поиска веб-элемента на
    // веб-странице с помощью XPath-выражения. В данном случае, элемент найден по XPath,
    ...
    public LoginPage fillEmailField(String email){
        // Этот метод заполняет поле электронной почты на веб-странице.
    ...
    private Alert getAlertIfPresent() {
        try {
            ...
            // ExpectedConditions.alertIsPresent() указывает,
            ...
            return null;
            // Возвращается null, что означает, что всплывающего окна не было обнаружено.
        }
    }
}