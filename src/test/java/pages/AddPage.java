...
public class AddPage extends BasePage {
    ...
    public void fillFormAndSave(Contact contact) {
       ...
       emailField.sendKeys(contact.getEmail());
        ...
        //часто ВебДрайвер очень быстро заполняет поля - так, что кнопка Сэйв не  успевает отобразиться
        //тогда не на что нажимать и выведется нал, для этого используется ВэбДрайверВэйт
