...
public class AlertHandler {
    ...
    public static boolean handleAlert(Alert alert, String expectedText) {
        if(alert != null) { // Эта строка проверяет, что объект Alert не равен null,
            // то есть всплывающее окно существует.
            ...
            return alertText.contains(expectedText); // Возвращает true, если
            // текст в всплывающем окне содержит ожидаемый текст (expectedText),
            //в противном случае возвращает false.
        }
       return false;
    }
