...
//    }
// две константы MIN_LENGTH и MAX_LENGTH представляют минимальную
// и максимальную длину телефонного номера соответственно.

    private static final int MIN_LENGTH = 10;
    private static final int MAX_LENGTH = 15;

    // метод generatePhoneNumber генерирует случайный телефонный номер.
    // Длина телефонного номера выбирается случайным образом в диапазоне
    // от MIN_LENGTH до MAX_LENGTH.
